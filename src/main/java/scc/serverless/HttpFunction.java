...
public class HttpFunction {
	...
	@FunctionName("del-channel")
	public HttpResponseMessage delChannel(@HttpTrigger(name="req", 
													methods = {HttpMethod.DELETE}, 
													authLevel = AuthorizationLevel.ANONYMOUS, 
													route = "serverless/delchannel/{id}")
				HttpRequestMessage<Optional<String>> request,
		...
		try {
			...
			request.createResponseBuilder(HttpStatus.INTERNAL_SERVER_ERROR).body(id).build();
		}
